...
export function RegisterForm() {
  ...
  return (
    <div className="space-y-5">
      {/* First, and the label says "Continue" rather than "Sign up": with OAuth
          the two screens are the same act, and Supabase creates the account on
          first arrival either way. */}
